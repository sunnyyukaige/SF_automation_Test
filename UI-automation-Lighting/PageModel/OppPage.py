...
class OppPage(BasePage):
    ...
    # Select Marketing Channel Group
    def selectMarketingChannelGroup(self,value):
        self.select_by_label('Marketing Channel Group',value)

    # Select Marketing Channel
    def selectMarketingChannel(self,value):
        self.select_by_label('Marketing Channel',value)

    # Select Marketing Sub-Channel
    def selectMarketingSubChannel(self,value):
        self.select_by_label('Marketing Sub-Channel',value)
